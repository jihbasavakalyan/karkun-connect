        ...
        <>
          ...
          <div className="rounded-2xl border border-border bg-surface-muted px-4 py-4">
            ...
            <div className="mt-2 grid gap-2 sm:grid-cols-3 lg:grid-cols-5">
              ...
              <StatCard label="Connected" value={report.summary.assigned} />
              <StatCard label="Not Connected" value={report.summary.unassigned} />
          ...
          <div className="rounded-2xl border border-border bg-surface-muted px-4 py-4">
            ...
            <ul className="mt-2 space-y-2">
              ...
              />
              <CheckRow
                label={`Connected count == Active Connection count (${report.consistency.assignedCount} / ${report.consistency.activeAssignmentCount})`}
