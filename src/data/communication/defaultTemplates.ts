...
آپ کی ذمہ داری سے متعلق ملاقات کی تفصیلات یہ ہیں:
تاریخ: {date}
وقت: {time}
...
ہفتہ وار اجتماع آپ کی ذمہ داری کا اہم حصہ ہے — تفصیلات یہ ہیں:
تاریخ: {date}
وقت: {time}
مقام: {venue}
...
آپ کی ذمہ داری سے متعلق JIH Reporting App میں اندراج باقی ہے۔
براہ کرم جلد از جلد اندراج مکمل فرما لیجیے۔ اگر مدد درکار ہو تو بتائیے۔
...
{month} کے ماہانہ بیت المال کی تکمیل آپ کی ذمہ داری کا حصہ ہے۔
براہ کرم جلد از جلد ادا فرما دیجیے۔
...
قرآن مجید مع ترجمہ کی باقاعدہ تلاوت و مطالعہ آپ کی ذمہ داری سے متعلق اہم معمول ہے۔
...
حدیث کا مطالعہ جاری رکھنا آپ کی ذمہ داری سے متعلق مفید معمول ہے۔
...
اسلامی ادب کا مطالعہ آپ کی ذمہ داری سے متعلق مفید معمول ہے۔
