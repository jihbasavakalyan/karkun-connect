...
export const MAIL_MERGE_VARIABLES: readonly MailMergeVariableDef[] = [
  ...
  { key: 'AssignedKarkunList', label: 'Assigned Karkun List', audiences: ['rukn'] },
  { key: 'ConnectedCount', label: 'Connected Count', audiences: ['rukn'] },
  { key: 'KarkunWord', label: 'Karkun / Karkunan (dynamic)', audiences: ['rukn'] },
  { key: 'AssignmentCount', label: 'Assignment Count', audiences: ['rukn'] },
  ...
  { key: 'DaysSinceAssignment', label: 'Days Since Assignment', audiences: ['rukn'] },
