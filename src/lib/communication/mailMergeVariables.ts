...
export const MAIL_MERGE_VARIABLES: readonly MailMergeVariableDef[] = [
  ...
  { key: 'AssignedKarkunCount', label: 'Connected Karkun Count', audiences: ['rukn'] },
  { key: 'AssignedKarkunList', label: 'Connected Karkun List', audiences: ['rukn'] },
  { key: 'ConnectedCount', label: 'Connected Count', audiences: ['rukn'] },
  { key: 'KarkunWord', label: 'Karkun / Karkunan (dynamic)', audiences: ['rukn'] },
  { key: 'AssignmentCount', label: 'Connection Count', audiences: ['rukn'] },
  { key: 'PendingCount', label: 'Pending Count', audiences: ['rukn'] },
  { key: 'PendingObjectives', label: 'Pending Objectives', audiences: ['rukn'] },
  { key: 'CampaignProgress', label: 'Campaign Progress', audiences: ['rukn'] },
  { key: 'DaysSinceAssignment', label: 'Days Since Connection', audiences: ['rukn'] },
  { key: 'LastActivity', label: 'Last Activity', audiences: ['rukn'] },
  { key: 'PendingFirstContact', label: 'Pending First Contact', audiences: ['rukn'] },
  { key: 'PendingFollowUps', label: 'Pending Follow-ups', audiences: ['rukn'] },
  { key: 'RecentlyAddedKarkuns', label: 'Recently Added Karkuns', audiences: ['rukn'] },
  { key: 'RecentlyRemovedKarkuns', label: 'Recently Removed Karkuns', audiences: ['rukn'] },
  { key: 'CompletedVisits', label: 'Completed Visits', audiences: ['rukn'] },
  { key: 'PendingVisits', label: 'Pending Visits', audiences: ['rukn'] },
  { key: 'TodaysVisits', label: "Today's Visits", audiences: ['rukn'] },
  { key: 'VisitProgress', label: 'Visit Progress', audiences: ['rukn'] },
  { key: 'WeeklyIjtemaProgress', label: 'Weekly Ijtema Progress', audiences: ['rukn'] },
  { key: 'MonthlyBaitulMaalProgress', label: 'Monthly Baitul Maal Progress', audiences: ['rukn'] },
  { key: 'AppRegistrationProgress', label: 'App Registration Progress', audiences: ['rukn'] },
  { key: 'PendingResponsibilities', label: 'Pending Responsibilities', audiences: ['rukn'] },
  { key: 'CompletedResponsibilities', label: 'Completed Responsibilities', audiences: ['rukn'] },
  { key: 'CampaignSummary', label: 'Campaign Summary', audiences: ['rukn'] },
  { key: 'PersonalNote', label: 'Personal Note (editable)', audiences: ['rukn'] },
  { key: 'AdditionalRemarks', label: 'Additional Remarks (editable)', audiences: ['rukn'] },
  { key: 'ClosingMessage', label: 'Closing Message (editable)', audiences: ['rukn'] },
