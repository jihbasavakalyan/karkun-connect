...
function createDefaultAutomationRules(): AutomationRule[] {
  ...
  return [
    ...
    base(
      'rule-ijtema-window-open',
      'Ijtema Attendance Window Open',
      'ijtema-window-open',
      'tpl-ijtema',
      'KC-028C — notify eligible Rukns when the weekly attendance window opens.',
    ),
    base(
      'rule-ijtema-incomplete',
      'Ijtema Incomplete Reminder',
      'ijtema-incomplete-reminder',
      'tpl-ijtema',
      'KC-028C — remind Rukns with incomplete attendance near end of window.',
    ),
