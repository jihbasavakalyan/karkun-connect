...
console.log('▶ Home wiring — existing Rukn dashboard, no new nav/framework')
{
  ...
  assertIncludes(layout, "label: 'Meeqati Mansooba'", 'Meeqati Mansooba nav retained')
  assertIncludes(layout, "label: 'Responsibilities'", 'Responsibilities nav retained')
  assertIncludes(layout, "label: 'Communication'", 'Communication nav retained')
