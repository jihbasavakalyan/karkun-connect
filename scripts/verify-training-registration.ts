...
function testPublicCopyAndPayment(): void {
  ...
  assert(admin.includes("title=\"UPI Pending\""), 'upi pending remains an existing queue section')
  assert(admin.includes("title=\"Rukn tracking\""), 'rukn tracking remains a section')
  assert(admin.includes("useState('')"), 'training sections start collapsed')
