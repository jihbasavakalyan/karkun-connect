...
console.log('▶ UI wiring — existing Admin/Rukn/Person surfaces, campaign journey kept')
{
  ...
  assertNotIncludes(home, 'RuknActionDashboardPanel', 'now-actions not composed on redesigned Home')
  assertNotIncludes(home, 'RuknWorkActionPanel', 'Work panel not composed on redesigned Home')
  assertNotIncludes(home, 'ActionableNotificationsPanel', 'notifications not composed on Home')
  assertNotIncludes(home, 'RuknMessageAdminPanel', 'message Admin not composed on Home')
  assertNotIncludes(home, 'ContinuousJourneyCountsStrip', 'journey counts not composed on Home')
