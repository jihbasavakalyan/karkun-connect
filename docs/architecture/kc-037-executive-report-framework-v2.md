...
| **1** | KC-037A | Report Config model + section registry + CanonicalMetricProviders binding; keep PDF default |
...
| **6** | KC-037F | Trends (where history exists) + Rafeeq insights + recommended actions with owners |
