...
|----------|-----------------|---------|--------|
| Compliance section `baitul-maal` | `/admin/compliance` | summaries + `updateBaitulMaal` | **Legacy** |
| `ComplianceSummaryCards` | Compliance | `getBaitulMaalDashboardMetrics` | **Legacy** |
